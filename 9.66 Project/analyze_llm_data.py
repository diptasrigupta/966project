...
data.to_csv('normalized_llm_data.csv')
...
def plot_kde(data, ax, label, color, x_min, x_max):
...
# KDE for male height
plot_kde(data.iloc[3:, height_male_extremely + height_female_extremely].values.flatten(), axes[0], 'Extremely', 'red', 0, 20)
plot_kde(data.iloc[3:, height_male_very + height_female_very].values.flatten(), axes[0], 'Very', 'yellow', 0, 20)
plot_kde(data.iloc[3:, height_male_none + height_female_none].values.flatten(), axes[0], 'None', 'green', 0, 20)
...
# KDE for temperature
plot_kde(data.iloc[3:, temperature_extremely].values.flatten(), axes[1], 'Extremely', 'red', 0, 3)
plot_kde(data.iloc[3:, temperature_very].values.flatten(), axes[1], 'Very', 'yellow', 0, 3)
plot_kde(data.iloc[3:, temperature_none].values.flatten(), axes[1], 'None', 'green', 0, 3)
...
plt.tight_layout()
plt.savefig('figures/distributions_llm_data.png')
